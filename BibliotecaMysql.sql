...
create table biblioteca (idBiblioteca int primary key auto_increment, cnpj varchar(14) unique, razaoSocial varchar(200), 
nomeFantasia varchar(200), telefone varchar(100), email varchar(100));
...
select * From livros;
SELECT * FROM biblioteca WHERE idBiblioteca = 2;
